...
![Now playing tab that display currently played song on Spotify, current time slot and checklist feature.](.github/img/now_playing.png)
...
![Schedule tab contains your Spotify playlist schedule - start and end times.](.github/img/schedule.png)
...
![Playlist tab that contains selected playlist for specific time slot and user's playlists from Spotify.](.github/img/playlist.png)
...
## Settings
![Settings tab](.github/img/settings.png)
